...
# for nome, valore in names.items():
#     print(f"{nome:<24}{e_points[countir]:>7}{l[countir]:>10}{ea_points[countir]:>10}{sumer[countir]:>11}{valore:>9}")
#     countir +=1
countir = 0
print(f"{'name'}                          {'exec_nbr'}  {'exec_pts.'} {'exm_pts.'}  {'tot_pts.'}  {'grade'}")
for nome, valore in names.items():
    exec_nbr_str = str(e_points[countir]).rjust(10)
    exec_pts_str = str(l[countir]).rjust(10)
    exm_pts_str = str(ea_points[countir]).rjust(10)
    tot_pts_str = str(sumer[countir]).rjust(10)
    grade_str = str(valore).rjust(9)
    print(f"{nome:<22}{exec_nbr_str}{exec_pts_str}{exm_pts_str}{tot_pts_str}{grade_str}")
    countir +=1
